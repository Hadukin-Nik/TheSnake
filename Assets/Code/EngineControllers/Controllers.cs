...
namespace Code.Controller
{
    public sealed class Controllers : IInitialization, IExecute, ILateExecute, ICleanup    
    {
        ...
        {
            Cleanup();
            _initializeControllers.RemoveRange(0, _initializeControllers.Count);
            _executeControllers.RemoveRange(0, _executeControllers.Count);

            _lateControllers.RemoveRange(0, _lateControllers.Count);
            _cleanupControllers.RemoveRange(0, _cleanupControllers.Count);
        }

        public void DestroyAllExcludingInitialization()
        {
            Cleanup();
            _executeControllers.RemoveRange(0, _executeControllers.Count);
